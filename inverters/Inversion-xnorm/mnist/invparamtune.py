...
def paramtune_inverter(config=None):
    ...
    if os.path.exists('UnlearnGAN/Unlearn-Blocking/inverters/Inversion-xnorm/mnist/results')==False:
        os.makedirs('UnlearnGAN/Unlearn-Blocking/inverters/Inversion-xnorm/mnist/results')
    #-----------------------------------------------#
...
if __name__ == '__main__':
    ...
    wandb.login()
    config = sweep_config()
    sweep_id = wandb.sweep(config, project='inverter_paramtune_mnist')
