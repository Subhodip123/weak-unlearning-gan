...
class Generator(nn.Module):
    ...
    def estimate_fisher(self,sample_size=1,ckpt_path=None,batch_size=32):
      ...
      noise = self.mixing_noise(16, 512, 0.9, 'cuda')
      ...
      for l in loglikelihoods:
        cnt+=1
        print(cnt)
        loglikelihood_grads.append((autograd.grad(l,reqd_param,retain_graph=(cnt<len(loglikelihoods))),l))
